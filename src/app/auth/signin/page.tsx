      ...
      <div className="flex flex-wrap items-center">
        <div className="hidden w-full xl:block xl:w-1/2">
          <div className="px-26 py-17.5 text-center">
            <Link className="mb-5.5 inline-block" href="/auth/signin">
              {/* <Image
        ...
        <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
          <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
...

            {
              showAlert && (
                <>
                  <div className="flex w-full border-l-6 border-[#F87171] bg-[#F87171] bg-opacity-[15%] px-3 py-4 shadow-md dark:bg-[#1B1B24] dark:bg-opacity-30 md:p-4 mb-4">
                    ...
                    <div className="w-full">
                      <h5 className="mb-3 text-lg font-semibold text-[#B45454]">
