    ...
    <div className="grid grid-cols gap-6 sm:grid-cols px-20">
      <div className="flex flex-col gap-6">
        ...
        <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
          ...
          <form action="/Fees/BillPreview">
            <div className="p-6.5">
              <div className="mb-4.5 flex flex-col gap-6 xl:flex-row">
                <div className="w-full xl:w-1/2">
                  <label className="mb-3 block text-sm font-medium text-black dark:text-white">
                    Roll No<span className="text-meta-1">*</span>
                  </label>
                  <input
                    type="number"
              ...
              <div>
                ...
                <div className="relative z-20 bg-white dark:bg-form-input">
                  ...
                  >
                    ...
                    <option value="January" className="text-body dark:text-bodydark">
                      January
                    </option>
                    <option value="February" className="text-body dark:text-bodydark">
                      February
                    </option>
                    <option value="March" className="text-body dark:text-bodydark">
                      March
                    </option>
                    <option value="April" className="text-body dark:text-bodydark">
                      April
                    </option>
                    <option value="May" className="text-body dark:text-bodydark">
                      May
                    </option>
                    <option value="June" className="text-body dark:text-bodydark">
                      June
                    </option>
                    <option value="July" className="text-body dark:text-bodydark">
                      July
                    </option>
                    <option value="August" className="text-body dark:text-bodydark">
                      August
                    </option>
                    <option value="September" className="text-body dark:text-bodydark">
                      September
                    </option>
                    <option value="October" className="text-body dark:text-bodydark">
                      October
                    </option>
                    <option value="November" className="text-body dark:text-bodydark">
                      November
                    </option>
                    <option value="December" className="text-body dark:text-bodydark">
                      December
                    </option>
